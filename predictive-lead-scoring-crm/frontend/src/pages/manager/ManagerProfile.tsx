        ...
        <Card className="p-6 sm:p-8 bg-slate-900/80 border-slate-800 space-y-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-slate-800">
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-1 min-w-0">
                ...
                <p className="text-xs text-indigo-400 font-medium">Head of Enterprise & Direct Sales</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
            ...
            <div className="p-4 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-1">
              ...
              <span className="text-[10px] text-slate-400 font-medium">Monthly Pipeline Goal</span>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-1">
              ...
              <span className="text-[10px] text-slate-400 font-medium">+4.2% vs last month</span>
            </div>
          </div>
        </Card>

        {/* Card 2: Manager Responsibilities & Supervision Scope */}
        <Card className="p-6 sm:p-8 bg-slate-900/80 border-slate-800 space-y-4">
          <div className="flex items-center space-x-3 text-indigo-400 border-b border-slate-800 pb-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Authorized supervision powers for lead assignment & goal setting</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 flex items-start space-x-3">
              ...
              <div>
                <span className="font-bold text-slate-200 block">AI Automated Lead Distribution</span>
                <span className="text-[11px] text-slate-400">Reassign and allocate high-intent Hot leads to active sales representatives.</span>
              </div>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 flex items-start space-x-3">
              <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
              <div>
                <span className="font-bold text-slate-200 block">Team Goal & Target Management</span>
                <span className="text-[11px] text-slate-400">Define revenue quotas and track rep performance against monthly targets.</span>
              </div>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 flex items-start space-x-3">
              <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
              <div>
                <span className="font-bold text-slate-200 block">At-Risk Lead Resolution</span>
                <span className="text-[11px] text-slate-400">Monitor stale leads and trigger intervention workflows before deals drop off.</span>
              </div>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 flex items-start space-x-3">
              <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
              <div>
                <span className="font-bold text-slate-200 block">Revenue Forecasting & Reports</span>
                <span className="text-[11px] text-slate-400">Export CSV executive digests and AI pipeline probability forecasts.</span>
              </div>
            </div>
          </div>
        </Card>
